      ...
      {location.pathname !== "/" && (
        <div className="hidden md:flex space-x-8">
          ...
          >
            ...
            Upload
            <span
              className={`absolute left-0 bottom-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full ${
                isCurrent("/upload") ? "w-full" : "w-0"
              }`}
            ></span>
          </Link>
          ...
          {!noDataOnDashboard && (
            ...
            >
              ...
              <span
                className={`absolute left-0 bottom-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full ${
                  isCurrent("/dashboard") ? "w-full" : "w-0"
                }`}
              ></span>
            </Link>
          )}
